...
export const InputGroup = ({ scheme, ...props}) => {
  return (
    <GroupContainer>
      <Label><Title>{props.title}</Title><SubTitle>{props.subtitle}</SubTitle></Label>
      <TextInput
        scheme={scheme}
        type={props.type}
        id={props.id}
    ...
    <GroupContainer>
      ...
      <TagContainer scheme={scheme}>
        <ul>
          ...
          <TagInputContainer>
            <TagInput scheme={scheme} type="text" onKeyDown={props.onInputKeyDown} value={props.word} onChange={props.onChange}/>
          </TagInputContainer>
        </ul>
      </TagContainer>
    </GroupContainer>
